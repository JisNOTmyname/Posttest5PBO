...
abstract class Nasabah {
    ...
    // Abstract method untuk menghitung biaya admin
...
final class NasabahIndividu extends Nasabah {
    ...
    // Implementasi abstract method untuk NasabahIndividu
    @Override
    public double hitungBiayaAdmin() {
        return 10.0; // Contoh biaya admin untuk Nasabah Individu
    }
...
final class NasabahPerusahaan extends Nasabah {
    ...
    // Implementasi abstract method untuk NasabahPerusahaan
    @Override
    public double hitungBiayaAdmin() {
        return 20.0; // Contoh biaya admin untuk Nasabah Perusahaan
    }
...
final class NasabahPremium extends Nasabah {
    ...
    // Implementasi abstract method untuk NasabahPremium
    @Override
    public double hitungBiayaAdmin() {
        return 0.0; // Nasabah Premium tidak memiliki biaya admin
    }
